...
void Cannon::setOrientation(Ogre::Quaternion orientat){m_orientation = orientat;}
Ogre::Vector3 Cannon:: getPosition(){return m_position;}
Ogre::Quaternion Cannon:: getOrientation(){return m_orientation;}
float Cannon:: getLengthBarrel(){return m_lengthBarrel;}
float Cannon:: getRadiusBarrel(){return m_radiusBarrel;}
float Cannon:: getHeightAboveGround(){return m_heightAboveGround;}
float Cannon::getBaseCubeLength(){return m_baseCubeLength;}

#pragma endregion

Cannon::Cannon(Ogre::SceneNode * myGunBarrel, Ogre::Vector3 myPosition,float cubeLength, float myRadius, float myLength, float heightAboveGround) 
	: m_baseCubeLength(cubeLength)
{ // constructor
